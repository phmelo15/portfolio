...
export const styles = {
  Photo: "h-[170px] w-[170px] rounded-full mt-[100px]",
  ...
  Presentation: `max-w-md text-[32px] text-center md:max-w-full ${strongFontFamily.variable} font-strong font-extrabold md:text-[50px] mt-[20px]`,
